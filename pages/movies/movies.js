...
Page({
  ...
  onLoad:function(event){
    //正在热映api
    var in_theaters = app.globalData.doubanBase + "/v2/movie/in_theaters" +"?city=杭州&start=0&count=3";
    //即将上映api
...
//点击input搜索框显示搜索页面
  ...
  onBindBlur:function(event){
    ...
    var searchUrl = app.globalData.doubanBase + "/v2/movie/search?q=" + this.data.value +"&start=0&count=10"
    //调用url
